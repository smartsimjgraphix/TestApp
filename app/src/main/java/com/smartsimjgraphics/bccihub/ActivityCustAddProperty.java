...
public class ActivityCustAddProperty extends AppCompatActivity {
    ...
    String str_selected_prop_type, str_selected_prop_status, str_selected_prop_pay_status,
            str_selected_prop_year, str_selected_prop_pay_month, str_value_data_username;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cust_add_property);
    ...
    private void init() {
        ...
        et_propTitle = findViewById(R.id.id_et_prop_title_cust);
        et_propDistrict = findViewById(R.id.id_et_prop_district_cust);
        et_propLocation = findViewById(R.id.id_et_prop_location_cust);
        et_propSize = findViewById(R.id.id_et_prop_size_cust);
        et_propNumOfBedRooms = findViewById(R.id.id_et_prop_no_of_rooms_cust);
        et_propPrice = findViewById(R.id.id_et_prop_price_cust);
        et_propDescription = findViewById(R.id.id_et_prop_desc_cust);
        et_cust_email = findViewById(R.id.id_et_prop_cust_email_cust);
        et_cust_phone = findViewById(R.id.id_et_prop_cust_phone_cust);
        btnAddProperty = findViewById(R.id.id_btn_prop_add_cust);

        spinner_propType = findViewById(R.id.id_spinner_prop_type_cust);
        spinner_propStatus = findViewById(R.id.id_spinner_prop_status_cust);
        spinner_propPayStatus = findViewById(R.id.id_spinner_prop_pay_status_cust);
        spinner_propYear = findViewById(R.id.id_spinner_prop_year_cust);
        spinner_propPayMonth = findViewById(R.id.id_spinner_prop_pay_month_cust);
            ...
            StringRequest stringRequest = new StringRequest(Request.Method.POST,
                    ...
                    response -> {
                        ...
                        if (response.equalsIgnoreCase("Property created!")) {
                            ...
                            Toast.makeText(ActivityCustAddProperty.this, response, Toast.LENGTH_LONG).show();
                            Intent gotoUsers = new Intent(ActivityCustAddProperty.this,
                            ...
                            Toast.makeText(ActivityCustAddProperty.this, "Oops!! " +
                ...
                progressDialog.dismiss();
                Toast.makeText(ActivityCustAddProperty.this,
